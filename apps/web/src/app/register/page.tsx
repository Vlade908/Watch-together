...
import { Film, Lock, Mail, User, Eye, EyeOff, Loader2, AlertCircle, Sparkles } from "lucide-react";
    ...
    <div className="w-full max-w-md bg-[#141414]/85 backdrop-blur-2xl border border-white/10 rounded-2xl p-8 sm:p-10 shadow-2xl shadow-black/80">
      <div className="mb-8 text-center sm:text-left">
        ...
        <p className="text-sm text-neutral-400">
          {isRoomInvite
            ? "Crie sua conta em segundos para participar da sala de Watch Together."
            : "Junte-se à experiência definitiva de streaming compartilhado com amigos."}
        </p>
      </div>
      ...
      {isRoomInvite && (
        <div className="mb-6 p-3 bg-[#E50914]/15 border border-[#E50914]/30 rounded-xl flex items-center space-x-2.5 text-neutral-200 text-xs">
          ...
          <span>Cadastre-se para entrar direto na sessão síncrona com seus amigos!</span>
        </div>
      )}
